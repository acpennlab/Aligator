...
The software is compiled for Windows (32-bit) and is expected to runs on Windows versions that support 32-bit and 64-bit applications, although this has not been extensively tested. To run the compiled windows application, unpack the zip file and double-click the Aligator.exe file that you can find in the Compiled folder.
